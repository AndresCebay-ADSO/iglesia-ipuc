...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Editar Miembro</h1>

    <form method="POST" action="{{ route('members.update', $member) }}" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" id="birth_date" name="birth_date" value="{{ old('birth_date', $member->birth_date->format('Y-m-d')) }}" required
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <select id="gender" name="gender" required
                    ...
                    <option value="femenino" {{ old('gender', $member->gender) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="marital_status" name="marital_status" required
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                    <option value="">Seleccione...</option>
                    <option value="soltero" {{ old('marital_status', $member->marital_status) == 'soltero' ? 'selected' : '' }}>Soltero</option>
                    <option value="casado" {{ old('marital_status', $member->marital_status) == 'casado' ? 'selected' : '' }}>Casado</option>
                    <option value="viudo" {{ old('marital_status', $member->marital_status) == 'viudo' ? 'selected' : '' }}>Viudo</option>
                    <option value="divorciado" {{ old('marital_status', $member->marital_status) == 'divorciado' ? 'selected' : '' }}>Divorciado</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="ministry" name="ministry" required
                    ...
                    <option value="alabanza" {{ old('ministry', $member->ministry) == 'alabanza' ? 'selected' : '' }}>Alabanza</option>
                    <option value="jóvenes" {{ old('ministry', $member->ministry) == 'jóvenes' ? 'selected' : '' }}>Jóvenes</option>
                    <option value="niños" {{ old('ministry', $member->ministry) == 'niños' ? 'selected' : '' }}>Niños</option>
                    <option value="líderes" {{ old('ministry', $member->ministry) == 'líderes' ? 'selected' : '' }}>Líderes</option>
                    <option value="intercesión" {{ old('ministry', $member->ministry) == 'intercesión' ? 'selected' : '' }}>Intercesión</option>
                    <option value="ujieres" {{ old('ministry', $member->ministry) == 'ujieres' ? 'selected' : '' }}>Ujieres</option>
                    <option value="diaconía" {{ old('ministry', $member->ministry) == 'diaconía' ? 'selected' : '' }}>Diaconía</option>
                    <option value="multimedia" {{ old('ministry', $member->ministry) == 'multimedia' ? 'selected' : '' }}>Multimedia</option>
                    <option value="damas_dorcas" {{ old('ministry', $member->ministry) == 'damas_dorcas' ? 'selected' : '' }}>Damas Dorcas</option>
                    <option value="escuela_dominical" {{ old('ministry', $member->ministry) == 'escuela_dominical' ? 'selected' : '' }}>Escuela Dominical</option>
                    <option value="evangelismo" {{ old('ministry', $member->ministry) == 'evangelismo' ? 'selected' : '' }}>Evangelismo</option>
                    <option value="ninguno" {{ old('ministry', $member->ministry) == 'ninguno' ? 'selected' : '' }}>Ninguno</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="church_role" name="church_role" required
                    ...
                    <optgroup label="Roles Ministeriales">
                        <option value="pastor_principal" {{ old('church_role', $member->church_role) == 'pastor_principal' ? 'selected' : '' }}>Pastor Principal</option>
                        <option value="pastor_asociado" {{ old('church_role', $member->church_role) == 'pastor_asociado' ? 'selected' : '' }}>Pastor Asociado</option>
                        <option value="evangelista" {{ old('church_role', $member->church_role) == 'evangelista' ? 'selected' : '' }}>Evangelista</option>
                    </optgroup>
                    
                    <optgroup label="Junta Local">
                        <option value="secretario" {{ old('church_role', $member->church_role) == 'secretario' ? 'selected' : '' }}>Secretario</option>
                        <option value="tesorero" {{ old('church_role', $member->church_role) == 'tesorero' ? 'selected' : '' }}>Tesorero</option>
                        <option value="miembro_junta" {{ old('church_role', $member->church_role) == 'miembro_junta' ? 'selected' : '' }}>Miembro de Junta</option>
                    </optgroup>
                    
                    <optgroup label="Comité Damas Dorcas">
                        <option value="presidenta_dorcas" {{ old('church_role', $member->church_role) == 'presidenta_dorcas' ? 'selected' : '' }}>Presidenta</option>
                        <option value="vicepresidenta_dorcas" {{ old('church_role', $member->church_role) == 'vicepresidenta_dorcas' ? 'selected' : '' }}>Vicepresidenta</option>
                        <option value="secretaria_dorcas" {{ old('church_role', $member->church_role) == 'secretaria_dorcas' ? 'selected' : '' }}>Secretaria</option>
                        <option value="tesorera_dorcas" {{ old('church_role', $member->church_role) == 'tesorera_dorcas' ? 'selected' : '' }}>Tesorera</option>
                    </optgroup>
                    
                    <optgroup label="Comité Jóvenes">
                        <option value="presidente_jovenes" {{ old('church_role', $member->church_role) == 'presidente_jovenes' ? 'selected' : '' }}>Presidente</option>
                        <option value="vicepresidente_jovenes" {{ old('church_role', $member->church_role) == 'vicepresidente_jovenes' ? 'selected' : '' }}>Vicepresidente</option>
                        <option value="secretario_jovenes" {{ old('church_role', $member->church_role) == 'secretario_jovenes' ? 'selected' : '' }}>Secretario</option>
                        <option value="tesorero_jovenes" {{ old('church_role', $member->church_role) == 'tesorero_jovenes' ? 'selected' : '' }}>Tesorero</option>
                    </optgroup>
                    
                    <optgroup label="Escuela Dominical">
                        <option value="director_escuela_dominical" {{ old('church_role', $member->church_role) == 'director_escuela_dominical' ? 'selected' : '' }}>Director</option>
                        <option value="subdirector_escuela_dominical" {{ old('church_role', $member->church_role) == 'subdirector_escuela_dominical' ? 'selected' : '' }}>Subdirector</option>
                        <option value="secretario_escuela_dominical" {{ old('church_role', $member->church_role) == 'secretario_escuela_dominical' ? 'selected' : '' }}>Secretario</option>
                    </optgroup>
                    
                    <optgroup label="Otros Roles">
                        <option value="líder" {{ old('church_role', $member->church_role) == 'líder' ? 'selected' : '' }}>Líder</option>
                        <option value="diácono" {{ old('church_role', $member->church_role) == 'diácono' ? 'selected' : '' }}>Diácono</option>
                        <option value="miembro" {{ old('church_role', $member->church_role) == 'miembro' ? 'selected' : '' }}>Miembro</option>
                        <option value="visitante" {{ old('church_role', $member->church_role) == 'visitante' ? 'selected' : '' }}>Visitante</option>
                    </optgroup>
                </select>
            </div>
            ...
            <div class="md:col-span-2">
                <label class="flex items-center">
                    <input type="checkbox" name="is_baptized" value="1" {{ old('is_baptized', $member->is_baptized) ? 'checked' : '' }}
            ...
            <div class="md:col-span-2">
                <label class="flex items-center">
                    <input type="checkbox" name="is_sealed" value="1" {{ old('is_sealed', $member->is_sealed) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
...
<script>
    ...
    function updateMinistryRoles() {
        ...
        if (selectedMinistry && selectedMinistry !== 'ninguno' && ministryRoles[selectedMinistry]) {
            ...
            const oldValue = '{{ old("ministry_role", $member->ministry_role ?? "") }}';
            if (oldValue) {
