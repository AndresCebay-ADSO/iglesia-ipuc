...
<head>
    ...
    <meta name="google-site-verification" content="zoKsYCILIi-iICKUitt3YWYwGPk5BeG2z_JRPnXvhO8" />
    ...
    <!-- Assets compilados con Vite (Tailwind v4 + JS) -->
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" name="password" type="password" autocomplete="current-password" required 
                                   ...
                                   placeholder="••••••••">
                            <button type="button" id="toggle-password-btn" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center" aria-label="Mostrar u ocultar contraseña" aria-pressed="false">
